...
/**
 * Test adaptive ACO v3 patch on sparse instances (494bus, 662bus)
 * where v3 previously underperformed v1, plus yeast for regression check.
 */
public class ACOAdaptiveTest {
    static final String[] INSTANCES = {"494bus", "662bus", "yeast"};
    static final int RUNS = 3;

    public static void main(String[] args) throws Exception {
        String timestamp = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"));
        java.nio.file.Path outputPath = Paths.get("src/main/output/experiments/ACOAdaptive_" + timestamp + ".csv");
