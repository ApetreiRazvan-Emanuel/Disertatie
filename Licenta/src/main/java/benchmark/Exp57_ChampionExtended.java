...
public class Exp57_ChampionExtended {
    static final int RUNS = 10;

    public static void main(String[] args) throws Exception {
        String configName = "ILP+Roulette_pop2000_elite200_champion";

        String timestamp = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"));
        java.nio.file.Path outputPath = Paths.get("src/main/output/experiments/Exp57_ChampionExtended_" + timestamp + ".csv");
        ...
        try (BufferedWriter csv = Files.newBufferedWriter(outputPath)) {
            ...
            for (int r = 0; r < RUNS; r++) {
                ...
                csv.write(String.format("%s,yeast,%d,%d,%d,%d,2000,200,0.5,ROULETTE,%d,%.3f,%.3f%n",
