...
public class Exp55_VeryHighElitism {
    static final int RUNS = 5;

    public static void main(String[] args) throws Exception {
        String configName = "ILP+Roulette_pop2000_elite250";

        String timestamp = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"));
        java.nio.file.Path outputPath = Paths.get("src/main/output/experiments/Exp55_VeryHighElitism_" + timestamp + ".csv");
        ...
        try (BufferedWriter csv = Files.newBufferedWriter(outputPath)) {
            ...
            for (int r = 0; r < RUNS; r++) {
                ...
                csv.write(String.format("%s,yeast,%d,%d,%d,%d,2000,250,0.5,ROULETTE,%d,%.3f,%.3f%n",
